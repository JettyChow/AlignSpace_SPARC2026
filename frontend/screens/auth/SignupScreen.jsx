...
export default function SignupScreen({ role, onSignup, onGoogle, onApple, onBack, onLogin }) {
    ...
    <DarkScene>
      <div style={{ position: 'absolute', inset: 0, padding: '70px 24px 30px', overflowY: 'auto', display: 'flex', flexDirection: 'column', alignItems: 'center', boxSizing: 'border-box' }}>
        ...
        <div className="lg lg-drift" style={{
          ...
          <PrimaryButton onClick={() => onSignup?.({ fullName, email, pw })} style={{ marginTop: 4 }}>Sign up</PrimaryButton>

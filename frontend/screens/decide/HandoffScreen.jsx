    ...
    <DarkScene>
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px 28px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 36, padding: '8px 20px', borderRadius: 999, background: 'rgba(198,163,107,0.12)', border: '1px solid rgba(198,163,107,0.35)' }}>
          <div style={{ width: 28, height: 28, borderRadius: '50%', background: 'rgba(198,163,107,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-sans)', fontSize: 12, fontWeight: 700, color: 'var(--champagne)' }}>E</div>
          <span style={{ fontFamily: 'var(--font-sans)', fontSize: 14, fontWeight: 600, color: 'var(--champagne)' }}>Elena Ross · Lead Designer</span>
        </div>
